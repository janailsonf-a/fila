...
# Dev: desliga SSL obrigatório para simplificar a conexão do Laravel.
# Em produção, manter ON e configurar o CA no PDO.
resource "azurerm_mysql_flexible_server_configuration" "no_secure_transport" {
